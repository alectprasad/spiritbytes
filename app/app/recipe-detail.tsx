...
import { FoodPreferencesService, UserFoodPreferences } from "@/app/services/FoodPreferencesService";
...
export class RecipeDetailService {
  ...
  static async getRecipeDetails(recipeTitle: string, mood?: string): Promise<RecipeDetails> {
    try {
      ...
      ${dietaryText}${allergensText}Make sure the recipe is compatible with these requirements.`;
